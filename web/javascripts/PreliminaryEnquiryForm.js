...
PreliminaryEnquiryForm.init();


$('#alternatePER').on('click',function(e){
    window.open('SocialInvestigation.html','Social Investigation Report','scrollbars=yes,toolbar=no,menubar=no,status=no,height=500,width=1000');
    e.prevantdefault();
});
