...
<html>
    ...
    <body>
        ...
        <br><br>
                  <form method="post" action="SimpleReport.jsp">
                      <center><h4>FORM 5<br/>
    [Rule 10 (2)]<br/>
    ORDER FOR SOCIAL INVESTIGATION REPORT</h4></center>
    
    
    <span style="margin-left: 16.5%">FIR No<input type="text" class="form" ></span><br><br>
    <span style="margin-left: 16.5%">U/Sections<input type="text" class="form" ></span><br>    
    <br>
    <span style="margin-left: 16.5%">Police Station<input type="text" class="form" ></span><br>
    <br>
    ...
    <span style="margin-left: 16.5%;word-spacing: 2px">Whereas<input type="text" class="form" size="16">(Name of the Child), son/daughter of<input type="text" class="form" size="17">age<input type="text" class="form" size="10">residing</span><br>
    
    <span style="margin-left: 16.5%">at<input type="text" class="form" >,has been produced before the Board.</span><br><br>
    ...
    <span style="margin-left: 16.5%">before<input type="text" class="form" >or within such time as allowed to you by the Board.</span><br><br>
    ...
    <span style="margin-left: 16.5%">Social Investigation Report.</span><br><br>
     ...
     <span style="margin-left: 16.5%">Dated this<input type="text" class="form" size="10">day of<input type="text" class="form" size="10">20<input type="text" class="form" size="10"></span><br><br>
