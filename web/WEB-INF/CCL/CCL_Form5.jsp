 ...
 $(document).ready(function() {
    $('#dialog5').on("click", function() {
        $('<div>').dialog({
            ...
            open: function ()
            {
                $(this).load('CCL_Form5de',{'profile_id':$('select#child').find('option:selected').val()});
...
[Rule 10 (2)]<br/>
ORDER FOR SOCIAL INVESTIGATION REPORT</h6>
...
<tr><td colspan="2" style="text-align: center"><br/><input style="text-align: center" id="dialog5" type="button" value="<s:text name="global.button.cwcProceed"/>"/></td></tr>
</table>
</s:form>
