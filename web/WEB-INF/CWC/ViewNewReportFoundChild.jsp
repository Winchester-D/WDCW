...
if(global > 1){
     $("#myTable tr").remove();
         ...
         //tr = $('#myTable > tbody:last-child').append('<tr>...</tr><tr>...</tr>'); //$('</b>');
            ...
            tr.append("<tr><td>Profile Id:</td><td>" + data.profileId+ "</td></tr>");
        ...
        <center>
<CAPTION><font size="3"><b>View Details of Found Child</b></font></CAPTION> 
<form name="Form17" id="Form17" action="CWC_Meetings17rep" target="_blank">
       <table><tr>     
               <td>Select ID:   &nbsp;&nbsp;&nbsp;  <s:select id="child"   list="foundchildrenlist"  listKey="profileId" listValue="profileId+'-->'+firstName" name="found_child" onchange="myreport(this)" theme="simple"/>  </td><td><span style="padding-left:20px"></span><input style="text-align: center" type="submit" value="Generate Form17"/></td>
              </tr><!--tr> 
               <td></td><td><span style="padding-left:20px"></span><input style="text-align: center" type="submit" value="Generate Case Monitoring Sheet"/></td>
             </tr-->
       </table>
</form>
