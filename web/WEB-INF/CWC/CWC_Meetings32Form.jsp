 ...
 $(document).ready(function() {
    $('#dialog32').on("click", function() {
        $('<div>').dialog({
            ...
            open: function ()
            {         
                $(this).load('CWC_Meetings32Formde',{'profile_id':$('select#child').find('option:selected').val()}).css('background-color','#ccffff');         
            },         
            height: 700,
            width: 1100,
            title: 'Form 32'
     ...
     <body>
        <s:form name="cwcHomeSelectForm" id="cwcHomeSelectForm" action="CWC_Meetings32rep" method="POST" target="_blank">
