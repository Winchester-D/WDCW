...
<html>
 ...
 $(document).ready(function() {
    $('#dialog17').on("click", function() {
        $('<div>').dialog({
            modal: true,
            open: function ()
            {
                $(this).load('CWC_Meetings17Formde',{'profile_id':$('select#child').find('option:selected').val()}).css('background-color','#ccffff');
            },         
            height: 800,
            width: 1100,
            title: 'Form 17'
...
<table>
    ...
    <tr><td>Select Child Profile ID: </td><td>     <s:select id="child"  theme="simple" list="foundlist" name="found_child" listKey="key" listValue="value.profileId + '-->' + value.firstName"/></td> </tr> 
...
<tr><td colspan="2" style="text-align: center"><br/><input style="text-align: center" id="dialog17" type="button" value="<s:text name="global.button.cwcProceed"/>"/></td></tr>
</table>
</s:form>
