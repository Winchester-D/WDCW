 ...
 $(document).ready(function() {
    $('#dialog19').on("click", function() {
        $('<div>').dialog({
            ...
            open: function()
            {
                  $(this).load('CWC_Meetings19Form',{'profile_id':$('select#child').find('option:selected').val()}).css('background-color','#ccffff');
    ...
    <body>
        <s:form name="cwcHomeSelectForm" id="cwcHomeSelectForm" action="CWC_Meetings19rep" method="POST" target="_blank">
