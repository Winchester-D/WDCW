...
//Added by vinumol 08-03-2012
    ...
    public List<FcChildTemp> getFoundChildren() {
        try 
      {
          System.out.println("fetch fc child::getFoundChildren():DAO");
         List<FcChildTemp> fcList = (List<FcChildTemp>)hibernateTemplate.findByNamedQuery("FcChildTemp.findAll");
     ...
     */
    @Override
   public boolean saveFormDAO(Object fcForm)
    {
      try 
      {
          System.out.println("saving form"+fcForm);
        hibernateTemplate.save(fcForm);
        return true;
      }
      catch(Exception e)
      {
