...
<html>
                    ...
                    <tr>
                        ...
                        <td><div id="wwgrp_childName" class="wwgrp">
                                <div id="wwctrl_childName" class="wwctrl">
                                    <input name="childName"   value="" id="childName" onfocus="VirtualKeyboard.attachInput(this);currentTB = this.id;" type="text" /></div> </div>
                        </td>
                        <td></td>
                        <td>
                            <div id="div89">
                            ...
                            <div >
                                ...
                                <input type="button" value="Load Selected File" onclick="f1()">
                                <br> <br> 
    ...
    
        {
        ...
        
            {
            ...
            
                {
                    ...
                    document.getElementById("div89").appendChild(imageLoaded);
 ...
 image();
        ...
        {
            var x = document.getElementById("div89").innerHTML="";
        }
                    ...
                    <tr>
                        ...
                        <td><div id="wwgrp_identificationMarks" class="wwgrp">
                                <div id="wwctrl_identificationMarks" class="wwctrl">
                                    <input name="identificationMarks" value=""  id="identificationMarks" onfocus="VirtualKeyboard.attachInput(this);
                                            currentTB = this.id;" type="text"></div> </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><div id="wwgrp_age" class="wwgrp">
                                <div id="wwctrl_age" class="wwctrl">
                                    <input name="ageofchild"  value="" id="ageofchild" onfocus="VirtualKeyboard.attachInput(this);currentTB = this.id;" type="text" ></div> </div>

                        </td>
                    </tr>		
                    <tr>
                        <td align="right">Child Nature:</td>
                        <td><select id="childNature" name="childNature" onchange="case_childnature(this);" >
                    ...
                    <tr>
                        ...
                        <td><div id="wwgrp_age" class="wwgrp">
                                <div id="wwctrl_age" class="wwctrl">
                                    <input name="childNatureOthers" value="" id="childNatureOthers" disabled="disabled" onfocus="VirtualKeyboard.attachInput(this);
                                            currentTB = this.id;" type="text"></div> </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><div id="wwgrp_natureDisability" class="wwgrp">
                                <div id="wwctrl_natureDisability" class="wwctrl">
                                    <input name="natureDisability" value="" disabled="disabled" id="natureDisability" onfocus="VirtualKeyboard.attachInput(this);
                                            currentTB = this.id;" type="text"></div> </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select id="religion" name="religion" headerkey="1" headervalue="-- Please Select --" onchange="casework_dynamic(this);" theme="simple">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="fatherOccup" name="fatherOccup" value="" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;" dir="ltr" type="text"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="noBrothers" name="noBrothers" value="0" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;" type="text"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">No.Of Sisters:</td>
                        <td>
                            <input id="noSister" name="noSister" value="0" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;" type="text"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="addrParents" name="addrParents"  cols="20" rows="4" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;" ></textarea>
                    ...
                    <tr>
                        ...
                        <td><input id="education" name="education" value="" type="text" onfocus="VirtualKeyboard.attachInput(this);
                                currentTB = this.id;"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><div id="wwgrp_identificationMarks" class="wwgrp">
                                <div id="wwctrl_identificationMarks" class="wwctrl">
                                    <input name="identifiedProb" value="" id="identifiedProb" onfocus="VirtualKeyboard.attachInput(this);
                                            currentTB = this.id;" type="text"/></div> </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="right">Physical condition of the child:</td>
                        <td>
                            <input type='text' id="placefound" name="placefound" cols="20" rows="4" onfocus="VirtualKeyboard.attachInput(this);currentTB = this.id;"/>
                        </td>
                    </tr>
                    ...
                    <tr><td  align="right">The language used by child:
                        ...
                        <td>
                            <input type='text' id="placefound" name="placefound" cols="20" rows="4" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="athorisedaddress" value="" id="athorisedaddress" onfocus="VirtualKeyboard.attachInput(this);
                                    currentTB = this.id;" type="text" />
                        </td>
                    </tr>
                    <tr>
            ...
            <table>
                ...
                <table>
                    <tbody id="childlinetable" style="display: none">
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="detailOfcaller" value="" id="detailOfcaller" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text" /></div> </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="otherseriverow" style="display: none">
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="serviceother" value="" id="serviceother" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text"/></div> </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <table>
                    <tbody id="authorizedtable" style="display: none">
                        ...
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="athorisedperson" value="" id="athorisedperson" onfocus="VirtualKeyboard.attachInput(this);currentTB = this.id;" type="text" /></div> </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="athorisedage" value="" id="athorisedage" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text"/> </div> </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="athorisedsex" value="" id="athorisedsex" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text" /></div> </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="athorisedcontact" value="" id="athorisedcontact" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text" /></div> </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <table>
                    <tbody id="dcputable" style="display: none">
                        ...
                        <tr>
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="dpcudet" value="" id="dpcudet" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text" /></div> </div>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">Child Labor:</td>
                            <td><input id="labour" name="labour" value="Y" onchange="casework_labour(this);" type="radio"/>yes
                                <input id="labour" name="labour" value="N" onchange="casework_labour(this);" checked="true" type="radio"/>no
                            </td>
                        </tr>
                        ...
                        <tr id="labourrow1" style="display: none">
                            ...
                            <td>
                                <textarea id="workadd" name="workadd" cols="20" rows="4" onfocus="VirtualKeyboard.attachInput(this);
                                        currentTB = this.id;"></textarea>
                            </td>
                        </tr>
                        ...
                        <tr id="labourrow2" style="display: none">
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="workacarried" value="" id="workacarried" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text"/></div> </div>
                            </td>
                        </tr>
                        <tr id="labourrow3" style="display: none">
                            ...
                            <td ><div id="wwgrp_childNatureOthers" class="wwgrp">
                                    <div id="wwctrl_childNatureOthers" class="wwctrl">
                                        <input name="salary" value="" id="salary" onfocus="VirtualKeyboard.attachInput(this);
                                                currentTB = this.id;" type="text"/></div> </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="right">Remarks:</td>
                            <td>
                                <textarea id="remarks" name="remarks" cols="20" rows="4" onfocus="VirtualKeyboard.attachInput(this);
                                        currentTB = this.id;"></textarea>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table>    
                    <tr>
                        ...
                        <td align="right"><input value="Save"  type="submit" /></td>
