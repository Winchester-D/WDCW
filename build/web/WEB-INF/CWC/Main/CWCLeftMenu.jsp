...
<s:elseif test="#session.roleid == -3">
        ...
        <div style="margin-left: 10%">
            <table rules="rows" cellpadding="1" cellspacing="1" align="left">
                ...
                <tbody >
                        ...
                        <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                       ...
                       <tr align="left" valign="top" onmouseover="this.style.background='grey'" onmouseout="this.style.background='white'">
                        <td><a href="CW-HomeStudyDE" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" style="text-decoration: none;color: green">Enter Home Study Details</a></td>
                    </tr>
                       
                        <!--tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'" id="cwc-data-bg">
	...
	<div style="margin-left: 10%">
            <table rules="rows" cellpadding="1" cellspacing="1" align="left">
                <tbody>     
                    <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('getHandOverde20')" style="text-decoration: none;color: green">Undertaking By The Parent</s:a></td>
                    </tr>    
                     <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('utFosCarede')" style="text-decoration: none;color: green">Undertaking By The Foster Family/Group Foster Care</s:a></td>
                    </tr>       
                         
                    <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'"> 
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('getHandOver')" style="text-decoration: none;color: green">View Undertaking By The Parent</s:a></td>
                    </tr>  
                       <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'"> 
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('utFosCare')" style="text-decoration: none;color: green">View Undertaking By The Foster Family/Group Foster Care </s:a></td>
                    </tr>  
               </tbody>
            </table>
        </div>
            ...
            <h3 style="margin-left: 10%"><a href="#">Records</a></h3>
	<div style="margin-left: 10%">
            <table rules="rows" cellpadding="1" cellspacing="1" align="left">
            ...
            <h3 style="margin-left: 10%"><a href="#">Applications </a></h3>      
            <div style="margin-left: 10%">
                <table rules="rows" cellpadding="1" cellspacing="1" align="left">

                    <tbody>     
                        <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                            <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('certAdoption25')" style="text-decoration: none;color: green">Declare the Child Legally Free</s:a></td>
                        </tr>  
                          <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'"> 
                             <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('appFFInclde')" style="text-decoration: none;color: green">Application For Fit Facility/ Group Foster Care</s:a></td>
                         </tr> 
                        ...
                        <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                            <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('deedSurde')" style="text-decoration: none;color: green">View Legally Free Certificate</s:a></td>
                        </tr>  
                       <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                             <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('appFFIncl')" style="text-decoration: none;color: green">View Application For Fit Facility/Group Foster Care</s:a></td>
                       </tr>  
                </tbody>
            </table>
        </div>
                       
                         <h3 style="margin-left: 10%"><a href="#">Certificates</a></h3>
	<div style="margin-left: 10%">
            <table rules="rows" cellpadding="1" cellspacing="1" align="left">
               <tbody>     
                    <!--tr align="left" valign="top" onmouseover="this.style.background='grey'" onmouseout="this.style.background='aliceblue'">
                        <td><a href="CW-ViewNewReportFoundChild" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" style="text-decoration: none;color: green">Case Monitoring Sheet</a></td>
                         ...
                         <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'">
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('certFFInclde')" style="text-decoration: none;color: green">Certificate Of Recognition <br/>Of Fit Facility /Group Foster Care</s:a></td>
                    </tr> 
                    
                   
                  <tr align="left" valign="top" onmouseover="this.style.background = 'grey'" onmouseout="this.style.background = 'white'"> 
                        <td><s:a href="javascript:;" onmouseover="this.style.color='white'" onmouseout="this.style.color='green'" onclick="switchContent('certFFIncl')" style="text-decoration: none;color: green">View Certificate Of Recognition <br/>Of Fit Facility Including Group Foster Care</s:a></td>               
                    </tr>
                 </tbody>
            </table>
         </div>         
