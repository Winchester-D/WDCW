 ...
 $(document).ready(function() {
    $('#dialog21').on("click", function() {
        $('<div>').dialog({
            ...
            open: function ()
            {
                $(this).load('CWC_Meetings21Formde',{'profile_id':$('select#child').find('option:selected').val()}).css('background-color','#ccffff'); 
            },         
             height: 700,
            width: 1200,
            title: 'Form 21'
     ...
     <body>
        <s:form name="cwcHomeSelectForm" id="cwcHomeSelectForm" action="CWC_Meetings21rep" method="POST">
