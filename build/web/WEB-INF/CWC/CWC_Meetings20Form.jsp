...
<html>
            ...
            $(document).ready(function () {
                $('#dialog20').on("click", function () {
                    $('<div>').dialog({
                        ...
                        open: function ()
                        {
                            $(this).load('CWC_Meetings20Formde', {'profile_id': $('select#child').find('option:selected').val()}).css('background-color', '#ccffff');
                        },
                        height: 700,
                        width: 1200,
                        title: 'Form 20'
    ...
    <body>
        <s:form name="cwcHomeSelectForm" id="cwcHomeSelectForm" action="CWC_Meetings20rep" method="POST">
