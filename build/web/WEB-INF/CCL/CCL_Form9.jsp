...
<html>
 ...
 $(document).ready(function() {
    $('#dialog9').on("click", function() {
        $('<div>').dialog({
            modal: true,
            open: function ()
            {
                $(this).load('CCL_Form9de',{'profile_id':$('select#child').find('option:selected').val()});
...
<tr><td colspan="2" style="text-align: center"><br/><input style="text-align: center" id="dialog9" type="button" value="<s:text name="global.button.cwcProceed"/>"/></td></tr>
</table>
</s:form>
